...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; padding: 32px 16px; color: #1A1A1A; background: #FDFBF7;">
  <div style="background: #F3EDE2; color: #171411; padding: 32px; border: 1px solid #DED4C7; border-bottom: none; border-radius: 8px 8px 0 0; text-align: center;">
    <h1 style="margin: 0; font-size: 24px;">Du er påmeldt</h1>
  </div>
  <div style="background: white; padding: 32px; border: 1px solid #DED4C7; border-top: none; border-radius: 0 0 8px 8px;">
    ...
    <hr style="border: none; border-top: 1px solid #DED4C7; margin: 24px 0;">
